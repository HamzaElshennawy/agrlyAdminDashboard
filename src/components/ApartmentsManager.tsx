...
export function ApartmentsManager() {
    ...
    const handleEditIconClick = (apartment: Apartment) => {
    ...
    const handleEditFormSubmit = async (e: React.FormEvent) => {
        ...
        try {
            console.log(editApartment, editForm);
            const response = await apiService.updateApartment(
                editApartment.id,
                editForm as Apartment
            );
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            {apartment.apartment_tags &&
                                apartment.apartment_tags.length > 0 && (
                                    <div className="mt-3 flex flex-wrap gap-1">
                                        ...
                                        {apartment.apartment_tags.length >
                                            3 && (
                ...
                {showEditModal && editApartment && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-lg p-6 w-full max-w-3xl text-left max-h-[95vh] overflow-y-auto">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={editForm.availabilityStatus || 0}
                                        onChange={handleEditFormChange}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                    />
                                </div>
                                ...
                                <div className="flex gap-4 mt-2">
                                    <label className="flex items-center gap-2">
                                        <input
                                            className="w-4 h-4 text-red-600 bg-red-500 rounded border-red-500 focus:text-red-500 enabled:bg-red-600"
                                            type="checkbox"
                                            name="instantBook"
                                            checked={!!editForm.instantBook}
                                            onChange={handleEditFormChange}
                                        />
                                        <span>is Instant Book</span>
                                    </label>
                                </div>
