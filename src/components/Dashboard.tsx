  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      if (usersResponse.status === "fulfilled" && usersResponse.value) {
        totalUsers = Array.isArray(usersResponse.value)
          ? usersResponse.value.length
          : 0;
      }

      if (
        apartmentsResponse.status === "fulfilled" &&
        apartmentsResponse.value
      ) {
        totalApartments = Array.isArray(apartmentsResponse.value)
          ? apartmentsResponse.value.length
          : 0;
      }
      ...
      if (
        ...
        const transactions = Array.isArray(transactionsResponse.value)
          ? transactionsResponse.value
          : [];
